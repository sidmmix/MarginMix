        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered campaign planning that transforms your marketing ideas into comprehensive, 
              data-driven media strategies across Google Ads, YouTube, Meta, and more.
            </p>
