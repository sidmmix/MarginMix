...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10 backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 shadow-xl border-0">
        ...
        <CardContent className="space-y-4">
          <Button 
            ...
            variant="outline" 
            className="w-full h-12 text-left flex items-center justify-start gap-3"
          >
            ...
            Continue to Margin Mix with Google
          </Button>
