    ...
    try {
      ...
      briefContent.innerHTML = `
        <div style="text-align: center; margin-bottom: 20px;">
          ...
          <h2 style="color: #1e40af; font-size: 16px; margin-bottom: 8px;">${latestBrief.clientName || latestBrief.campaignName}</h2>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 15px;">
          <div style="flex: 1;">
            <h3 style="color: #374151; font-size: 13px; margin-bottom: 8px; font-weight: bold;">Campaign Overview</h3>
          ...
          <div style="flex: 1;">
            <h3 style="color: #374151; font-size: 13px; margin-bottom: 8px; font-weight: bold;">Campaign Objectives</h3>
            <div style="color: #6b7280; font-size: 11px; line-height: 1.3;">
        ...
        <div style="margin-bottom: 15px;">
          <h3 style="color: #374151; font-size: 13px; margin-bottom: 8px; font-weight: bold;">Strategic Recommendations</h3>
          <ul style="color: #6b7280; font-size: 11px; line-height: 1.3; padding-left: 15px; margin: 0;">
            ${recommendations.map((rec: string) => `<li style="margin-bottom: 3px;">${rec}</li>`).join('')}
          </ul>
        </div>
        ` : ''}
