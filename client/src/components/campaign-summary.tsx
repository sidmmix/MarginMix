  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <div id="campaign-summary-content" className={`bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden mb-8 transition-all duration-500 ${isContentBlurred ? 'blur-md pointer-events-none' : ''}`}>
        ...
        <div className="bg-gradient-to-r from-emerald-600 via-emerald-700 to-teal-700 text-white p-8 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-3">
              Digital Media Campaign Brief{sessionData.company ? ` for ${sessionData.company}` : ''}
            </h2>
            <div className="flex items-center justify-center gap-3 text-emerald-100 mb-2">
              <div className="w-2 h-2 bg-emerald-200 rounded-full"></div>
              <span className="text-lg">Generated by Margin Mix Financial Reasoning Engine</span>
              <div className="w-2 h-2 bg-emerald-200 rounded-full"></div>
            </div>
      ...
      {isContentBlurred && !isAuthenticated && (
        <div className="text-center mb-6 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg border border-emerald-200 dark:border-emerald-700">
      ...
      <div className={`flex flex-col lg:flex-row gap-4 justify-center items-center ${isContentBlurred ? 'animate-pulse' : ''}`}>
        <Button 
          ...
          size="lg"
          className={`flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white shadow-lg hover:shadow-xl transition-all duration-200 ${isContentBlurred ? 'ring-4 ring-emerald-300 ring-opacity-75 scale-105' : ''}`}
        >
