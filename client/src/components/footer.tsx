      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-6">
            Contact: <a href="mailto:sid@marginmix.ai" className="text-emerald-400 hover:text-emerald-300">sid@marginmix.ai</a> <span className="text-white text-2xl leading-none align-middle">•</span> <a href="tel:+16286001309" className="text-emerald-400 hover:text-emerald-300">+1.628.600.1309</a>
          </p>
