...
export const marginAssessments = pgTable("margin_assessments", {
  ...
  industry: varchar("industry", { length: 100 }).notNull().default("marketing-advertising"),
  ...
  engagementClassification: varchar("engagement_classification", { length: 100 }).notNull().default("new"),
  ...
  deliveryConfidence: varchar("delivery_confidence", { length: 50 }).notNull().default("high"),
  aiHumanHoursReplaced: varchar("ai_human_hours_replaced", { length: 50 }).notNull().default("na"),
  aiCommercialImpactMeasured: varchar("ai_commercial_impact_measured", { length: 50 }).notNull().default("na"),
  aiAgenticFramework: varchar("ai_agentic_framework", { length: 50 }).notNull().default("na"),
